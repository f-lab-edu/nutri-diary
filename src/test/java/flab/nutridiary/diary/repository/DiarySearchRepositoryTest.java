...
class DiarySearchRepositoryTest extends TestContainerSupport {
    @Autowired
    ...
    void findDiaryWithProductsByMemberIdAndDiaryDate() throws Exception {
        ...
        // when
        List<DiaryRecordWithProduct> results = diarySearchRepository.findDiaryWithProductAllByMemberIdAndDiaryDate(memberId, LocalDate.of(2024, 8, 10));
