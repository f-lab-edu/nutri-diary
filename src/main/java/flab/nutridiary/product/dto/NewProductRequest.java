...
public class NewProductRequest {
    ...
    private BigDecimal productDefaultServingSize;

    @NotNull(message = "서빙 단위를 입력해주세요.")
    private String productDefaultServingUnit;
    ...
    @Builder
    private NewProductRequest(String productName, String corpName, BigDecimal productDefaultServingSize, String productDefaultServingUnit, BigDecimal productTotalWeightGram, BigDecimal calories, BigDecimal carbohydrate, BigDecimal protein, BigDecimal fat) {
        this.productName = productName;
        this.corpName = corpName;
        this.productDefaultServingSize = productDefaultServingSize;
        this.productDefaultServingUnit = productDefaultServingUnit;
